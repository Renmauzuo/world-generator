(function () {
    ...
    const planarTypes = {
        ...
        avatar: {
            ...
            customSetup: (node) => avatarSetup(node, getRegisteredNodes('greaterDeity', 'lesserDeity', 'demigod'), collectAncestorTags(node, objectTypesRef$1)),
        },
    };
    ...
    $(function () {
        ...
        $('#info-panel').on('input change', 'input,select,textarea', function () {
            ...
            if (attribute === 'race' && ((_a = selectedNode.attributes) === null || _a === void 0 ? void 0 : _a.lineage) !== undefined) {
                const newRaceKey = $(this)[0].value;
                const raceEntry = races.find(r => r.name === newRaceKey);
                const lineages = (_b = getLineages(raceEntry)) !== null && _b !== void 0 ? _b : [];
    ...
    function showInfoForNode(node) {
        ...
        if (node.attributes) {
            for (const attribute in node.attributes) {
                ...
                if (attribute === 'extraResistances' || attribute === 'dragonColor')
                    continue;
