...
const objectTypes = {
  ...
  triceratopsHerd: {
    ...
    children: [{
      type: 'triceratopsAdult',
      min: 2,
      max: 5
    }, {
      type: 'triceratopsJuvenile',
      min: 0,
      max: 3
    }]
  },
...
function scaleMonster(monster, targetCR, options = {}) {
    ...
    if (type === creatureTypes.humanoid && selectedMonster.race === raceKeys.any && currentRace && currentRace !== races$1[0]) {
        const abilityMods = derivedStats.abilityModifiers;
...
$(function () {
  ...
  $('body').on('click', '.button-view-statblock', function (e) {
    ...
    const cr = String((_b = (_a = selectedNode.attributes) === null || _a === void 0 ? void 0 : _a.challengeRating) !== null && _b !== void 0 ? _b : 1);
    try {
...
function showInfoForNode(node) {
  ...
  if (template.creature) {
    ...
    if ((_a = node.attributes) === null || _a === void 0 ? void 0 : _a.challengeRating) {
