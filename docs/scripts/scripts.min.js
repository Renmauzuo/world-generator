(function () {
    ...
    function showInfoForNode(node) {
        ...
        if (((_b = node.attributes) === null || _b === void 0 ? void 0 : _b.lineage) !== undefined && ((_c = node.attributes) === null || _c === void 0 ? void 0 : _c.race)) {
        ...
        const creatureID = template.dynamicCreature ? (_d = node.attributes) === null || _d === void 0 ? void 0 : _d.creature : template.creature;
        const creatureVariant = template.dynamicCreature ? (_e = node.attributes) === null || _e === void 0 ? void 0 : _e.variant : template.variant;
        const creatureLegendary = template.dynamicCreature ? (_f = node.attributes) === null || _f === void 0 ? void 0 : _f.legendary : template.legendary;
        if (creatureID) {
            ...
            if ((_g = node.attributes) === null || _g === void 0 ? void 0 : _g.challengeRating) {
            ...
            const genderStr = (_h = node.attributes) === null || _h === void 0 ? void 0 : _h.gender;
            if (genderStr) {
                const genderNum = genderStr === 'Male' ? 1 : genderStr === 'Female' ? 2 : 3;
                creatureLink += '&gender=' + genderNum;
            }
            // Pass alignment
            if ((_j = node.attributes) === null || _j === void 0 ? void 0 : _j.alignment) {
            ...
            if ((_k = node.attributes) === null || _k === void 0 ? void 0 : _k.race) {
