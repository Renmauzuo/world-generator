(function () {
    ...
    function selectDeityCreature(alignment, element, domainKey) {
        ...
        if (domain === null || domain === void 0 ? void 0 : domain.creatureOverrides) {
        ...
        const boostSet = new Set((_a = domain === null || domain === void 0 ? void 0 : domain.creatureBoosts) !== null && _a !== void 0 ? _a : []);
        const weights = {};
